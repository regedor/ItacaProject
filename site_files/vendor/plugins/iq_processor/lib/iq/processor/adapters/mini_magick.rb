...
class IQ::Processor::Adapters::MiniMagick < IQ::Processor::Adapters::Base
...
#    raise BadAssetProcessorError.new("Process method (#{method}) must return an object of type 'MiniMagick::Image' - it actually returned '#{result.class}'") unless result.kind_of?(::MiniMagick::Image)
#    result
#  end
#
