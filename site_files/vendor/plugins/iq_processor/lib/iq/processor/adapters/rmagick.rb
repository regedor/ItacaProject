...
class IQ::Processor::Adapters::Rmagick < IQ::Processor::Adapters::Base
...
#    raise BadAssetProcessorError.new("Process method (#{method}) must return an object of type 'Magick::Image' - it actually returned '#{result.class}'") unless result.kind_of?(Magick::Image)
#    result
#  end
#
